...
public class Login_Screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextEmail = (EditText) findViewById(R.id.emailUser); //initialize email of the user
        editTextPassword = (EditText) findViewById(R.id.passwordUser); //initialize password of the user
        buttonSignIn = (Button) findViewById(R.id.signInbutton); //initialize Sign in button
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(Login_Screen.this, R.string.auth_failed,
